  ...
  React.useEffect((function () {
          Curry._1(Web3Connectors$FlowsUserApp.injected.isAuthorized, undefined).then(function (authorised) {
                if (authorised && !triedLoginAlready) {
                  JsPromise$FlowsUserApp.$$catch(Curry._3(context.activate, Web3Connectors$FlowsUserApp.injected, (function (param) {
...
function useActivateConnector(param) {
  ...
  return [
          match[0],
          (function (provider) {
              JsPromise$FlowsUserApp.$$catch(Curry._3(context.activate, provider, (function (param) {
